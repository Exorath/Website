		...
		<nav class="navbar-2 navbar-exorath bg-inverse-2">
			<div class="container gap">
				<div class="header-image">
					<img style="height: 13em;" src="https://exorath.com/res/img/EXORATH_TRANS.png">
				</div>
				...
				<div id="collapsingNavbarInverse" class="collapse navbar-toggleable-custom" role="tabpanel" aria-labelledby="collapsingNavbarInverse">
					<ul class="nav navbar-nav pull-xs-center">
						...
						if($user_online){
							?>
								<li class="nav-item nav-item-toggable<?php if($page_name == "account") echo 'active';?>">
									<a class="nav-link" href="https://exorath.com/account">Account <?php if($page_name == "account") echo '<span class="sr-only">(current)</span>';?></a>
								</li>
								<li class="account dropdown hidden-sm-down">
